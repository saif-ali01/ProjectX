...
// TransactionsTable component for displaying and filtering transactions
const TransactionsTable = ({
  ...
  const inputStyles = `w-full p-2 sm:p-3 border rounded-lg focus:outline-none focus:ring-2 transition-colors duration-300 text-xs sm:text-sm`;
    ...
    >
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-xs sm:text-sm">
          <thead>
            ...
            >
              <th
                className="p-2 sm:p-3 cursor-pointer hover:text-blue-600 dark:hover:text-blue-400"
          ...
          <tbody>
            {transactions.length === 0 ? (
              ...
              >
                <td colSpan="5" className="p-2 sm:p-3 text-center">
              ...
              transactions.map((tx, idx) => (
                ...
                >
                  ...
                  <td className="p-2 sm:p-3">{tx.description}</td>
                  <td className="p-2 sm:p-3">{tx.category}</td>
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center mt-4 gap-3 sm:gap-0">
        <button
          ...
          className={`w-full sm:w-auto px-4 py-2 rounded-lg font-medium transition-transform hover:scale-105 disabled:opacity-50 text-sm sm:text-base ${
            darkMode
